...
@section('content')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            @include('partials.buttons.add', ['url'=>route('gallery.create')])
        </div>
    </div>
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                @foreach($photos as $photo)
                    ...
                    <form method="POST" action={{route('gallery.update', $photo->id)}}
                        ...
                        <div style="display: inline-block">
                            <form action="{{ route('gallery.delete', $photo->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
